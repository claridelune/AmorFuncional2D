...
(fn grow-shrink.init [rect init-params]
  ...
  (set rect.maxScale (or rect.maxScale (and init-params (init-params.maxScale)) 1.5))
  (set rect.minScale (or rect.minScale (and init-params (init-params.minScale)) 0.5))
  (set rect.growShrinkTransitionSpeed (or rect.growShrinkTransitionSpeed (and init-params (init-params.growShrinkTransitionSpeed)) 0.5))
